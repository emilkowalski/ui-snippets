...
export default {
  ...
  computed: {
    effects() {
      return [
        {
          css: rawCss.borderLeftRight,
          className: "borderLeftRight",
          category: "text",
          html: "Hover me"
        },
        {
          css: rawCss.donutSpinner,
        ...
        {
          css: rawCss.borderFade,
          className: "borderFade",
          category: "text",
          html: "Hover me"
        },
        {
          css: rawCss.arrowBounce,
        ...
        {
          rawCss: rawCss.lineThrough,
          className: "lineThrough",
          category: "text",
          html: "Hover me"
        },
        {
          rawCss: rawCss.overlayLeftBtn,
          className: "overlayLeftBtn",
          category: "button",
          html: "<span>Hover me</span>"
        },
        {
          rawCss: rawCss.textTransformX,
          className: "textTransformX",
          category: "text",
          html: "Hover me"
        },
        {
          rawCss: rawCss.arrowScrollDown,
        ...
        {
          rawCss: rawCss.swingHorizontal,
          className: "swingHorizontal",
          category: "text",
          html: "Hover me"
        },
        {
          rawCss: rawCss.pulseAnim,
          className: "pulseAnim",
          category: "text"
        },
        {
          rawCss: rawCss.visibleBorderLeftRight,
          className: "visibleBorderLeftRight",
          category: "text",
          html: "Hover me"
        },
        {
          rawCss: rawCss.slideUpBtn,
